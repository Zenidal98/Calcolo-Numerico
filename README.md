# Calcolo Numerico
Repo del progetto di Calcolo Numerico anno 2024-2025 del secondo anno di Informatica, Bologna.
...
The project required the use of Python on Google Colab to solve 14 different exercises.

The exercises cover topics such as solving linear systems, computing matrix conditioning, compressing images using SVD, least-squares approximation, finding function zeros, applying the gradient method to quadratic functions, and performing Deblurring and Super Resolution on given systems.
